...
<script>
    ...
    for(i=0;i<26;i++){
        b+="<a href='searchuser.php?let="+String.fromCharCode(65+i)+"'><button class='ml-2 text-white p-2 hover:bg-red-400 my-2'>"+String.fromCharCode(65+i)+"</button></a>";
    }
...
<script>
    ...
    for(i=1;i<num/100+1;i++){
        b+="<a href='user.php?c_name="+name+"&type="+type+"&city="+city+"&page="+i+"'><button class='text-white p-1 hover:bg-red-400  mr-2 p-1'>"+i+"</button></a>";
    }
    b+="&emsp;";
